...
public class FormulaParser extends Parser {
	...
	public final ConditionalContext conditional() throws RecognitionException {
		...
		try {
			...
			case T__8:
				...
				setState(59); ((ConditionalContext)_localctx).p = predicate_expression();
				setState(60); match(T__2);
				setState(61); ((ConditionalContext)_localctx).a = expression();
				setState(62); match(T__20);
				setState(63); ((ConditionalContext)_localctx).b = expression();
				}
				break;
			case LPAREN:
				enterOuterAlt(_localctx, 2);
				...
				setState(66); ((ConditionalContext)_localctx).p = predicate_expression();
				setState(67); match(T__5);
				setState(68); ((ConditionalContext)_localctx).a = expression();
				setState(69); match(T__18);
				setState(70); ((ConditionalContext)_localctx).b = expression();
	...
	public final Predicate_factorContext predicate_factor() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				if (_la==T__9) {
					{
					setState(127); ((Predicate_factorContext)_localctx).not = match(T__9);
					}
				}

				setState(130); predicate_atom();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				if (_la==T__3) {
					{
					setState(131); ((Predicate_factorContext)_localctx).not = match(T__3);
					}
				}

				setState(134); predicate_atom();
				}
				break;
			}
		}
	...
	public final Predicate_atomContext predicate_atom() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(138); greater();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(139); less_equal();
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(140); greater_equal();
				}
				break;
			case 5:
			...
			case 7:
				...
				setState(144); predicate_expression();
	...
	public final LessContext less() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(149); ((LessContext)_localctx).a = expression();
			setState(150); match(T__13);
			setState(151); ((LessContext)_localctx).b = expression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final GreaterContext greater() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(153); ((GreaterContext)_localctx).a = expression();
			setState(154); match(T__7);
			setState(155); ((GreaterContext)_localctx).b = expression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Less_equalContext less_equal() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(157); ((Less_equalContext)_localctx).a = expression();
			setState(158); match(T__4);
			setState(159); ((Less_equalContext)_localctx).b = expression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Greater_equalContext greater_equal() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(161); ((Greater_equalContext)_localctx).a = expression();
			setState(162); match(T__17);
			setState(163); ((Greater_equalContext)_localctx).b = expression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final EqualContext equal() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(165); ((EqualContext)_localctx).a = expression();
				setState(166); match(T__14);
				setState(167); ((EqualContext)_localctx).b = expression();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(169); ((EqualContext)_localctx).a = expression();
				setState(170); match(T__10);
				setState(171); ((EqualContext)_localctx).b = expression();
				}
				break;
			}
		}
	...
	public final Not_equalContext not_equal() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(175); ((Not_equalContext)_localctx).a = expression();
				setState(176); match(T__19);
				setState(177); ((Not_equalContext)_localctx).b = expression();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(179); ((Not_equalContext)_localctx).a = expression();
				setState(180); match(T__1);
				setState(181); ((Not_equalContext)_localctx).b = expression();
				}
				break;
			}
		}
	...
	public final AtomContext atom() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(201); scientific();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(202); variable();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
	...
	public static final String _serializedATN =
		...
		"\34\35\3\2 !\3\2 \"\u0108\28\3\2\2\2\4:\3\2\2\2\6K\3\2\2\2\be\3\2\2\2"+
		"\n\177\3\2\2\2\f\u0089\3\2\2\2\16\u0095\3\2\2\2\20\u0097\3\2\2\2\22\u009b"+
		"\3\2\2\2\24\u009f\3\2\2\2\26\u00a3\3\2\2\2\30\u00af\3\2\2\2\32\u00b9\3"+
		"\2\2\2\34\u00bb\3\2\2\2\36\u00c4\3\2\2\2 \u00c6\3\2\2\2\"\u00d1\3\2\2"+
		"\2$\u00d3\3\2\2\2&\u00d9\3\2\2\2(\u00e9\3\2\2\2*\u00ef\3\2\2\2,\u00f3"+
		...
		"<=\7\17\2\2=>\5\b\5\2>?\7\25\2\2?@\5\2\2\2@A\7\3\2\2AB\5\2\2\2BL\3\2\2"+
