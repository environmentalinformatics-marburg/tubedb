...
public class Handler_db_content extends MethodHandler {	


	public Handler_db_content(RemoteTsDB tsdb) {
		super(tsdb, "db_content.csv");
	}
	...
	public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		String[] streamNames = tsdb.getInternalStoredStreamNames();
		for(String streamName : streamNames) {
			int[] range = tsdb.getInternalStoredSensorTimeRange(streamName);
			String[] streamNameSensorNames = tsdb.getInternalStoredSensorNames(streamName);
