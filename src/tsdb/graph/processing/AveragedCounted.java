...
import tsdb.iterator.AverageCountIterator;
 ...
 *
 */
public class AveragedCounted extends Continuous.Abstract {	
	...
	public AveragedCounted(TsDB tsdb, List<Continuous> sources, String[] schema, int minCount, boolean withQualityMeasures) {
		super(tsdb);
		...
		this.outputSchema = AverageCountIterator.createOutputSensorNames(schema);
	}

	public static AveragedCounted of(TsDB tsdb, List<Continuous> sources, int minCount, boolean withQualityMeasures) {		
		...
		return new AveragedCounted(tsdb, sources, schemaSet.toArray(new String[0]), minCount, withQualityMeasures);
	}
	...
	public TsIterator getExactly(long start, long end) {		
		...
		return new AverageCountIterator(inputSchema, iteratorList.toArray(new TsIterator[0]), minCount, withQualityMeasures);		
	}
