...
public class StationMeta {
	...
	private static final String DB_NAME_SENSOR_TIME_SERIES_SUSPECT_MASK_MAP_PREFIX = "sensorTimeSeriesSuspectMaskMap/";
	...
	private StationMeta(String stationName, String db_name_sensor_map, String db_name_sensor_time_series_mask_map) {
		...
		this.db_name_sensor_time_series_suspect_mask_map = DB_NAME_SENSOR_TIME_SERIES_SUSPECT_MASK_MAP_PREFIX+stationName;
	}
