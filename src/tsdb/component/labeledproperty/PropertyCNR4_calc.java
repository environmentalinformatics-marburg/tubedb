...
public class PropertyCNR4_calc {

	private static final String[] names = new String[]{"SWDR_300_calc", "SWDR_300_U", "SWUR_300_calc", "SWUR_300_U", "LWDR_300_calc", "LWDR_300_U", "LWUR_300_calc", "LWUR_300_U", "Trad"};
	...
	public PropertyCNR4_calc(double swdr, double swur, double lwdr, double lwur) {
		this.swdr = swdr;
		this.swur = swur;
		this.lwdr = lwdr;
		this.lwur = lwur;
