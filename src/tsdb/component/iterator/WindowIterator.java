...
public abstract class WindowIterator extends InputIterator {
	...
	public WindowIterator(TsIterator input_iterator, int windowSizeMinutes, TsSchema output_schema) {
