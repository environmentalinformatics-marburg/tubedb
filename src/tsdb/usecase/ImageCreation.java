...
public class ImageCreation {
	...
	public static void main(String[] args) throws IOException {
		...
		TimeSeriesDiagram tsd = new TimeSeriesDiagram(timestampseries, aggregationInterval, diagramType, false, AggregatedConnectionType.STEP, RawConnectionType.LINE, AggregatedValueType.LINE, RawValueType.POINT, null);
