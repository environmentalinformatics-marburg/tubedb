...
public class InterpolationAnalysis2 {
	...
	public static void run(TsDB tsdb) {
		...
		Aggregated.of(tsdb, realNode, aggregationInterval, null, null, null, null).writeCSV(gapStart, gapEnd, path+"real.csv");
		Aggregated.of(tsdb, interpolatedNode, aggregationInterval, null, null, null, null).writeCSV(gapStart, gapEnd, path+"interpolated.csv");
		Aggregated.of(tsdb, meanNode, aggregationInterval, null, null, null, null).writeCSV(gapStart, gapEnd, path+"mean.csv");
		Aggregated.of(tsdb, nearNode, aggregationInterval, null, null, null, null).writeCSV(gapStart, gapEnd, path+"near.csv");
		
		Aggregated.of(tsdb, realNode, aggregationInterval, null, null, null, null).writeCSV(null, null, path+"real_full.csv");
		Aggregated.of(tsdb, nearNode, aggregationInterval, null, null, null, null).writeCSV(null, null, path+"near_full.csv");
