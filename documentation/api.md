...
TubeDB contains an API to query meta data, to process timeseries data and to create visualisations.

The API is a RESTful HTTP web service, that is easily acessible by most scripting (e.g. JavaScript, R) or programming environment that is capable of retrieving data by HTTP. It is used by the TubeDB web based user-interface.
